...
// Settings HTML canvas: 393×1767px
...
export default function SettingsPage() {
  ...
  // Modal state - opens when user clicks on form areas
  ...
  return (
    <div style={{ position: 'relative', width: '393px', margin: '0 auto' }}>
      ...
      <div style={{
        ...
        {/* Profile form area – click to open profile edit modal */}
        ...
        <button id="nav-home" onClick={() => router.push('/home')}
          style={{ position: 'absolute', top: 1707, left: 39, width: 64, height: 59, background: 'transparent', border: 'none', cursor: 'pointer', pointerEvents: 'auto' }} />
        <button id="nav-kelas" onClick={() => router.push('/watch/1')}
          style={{ position: 'absolute', top: 1707, left: 103, width: 64, height: 59, background: 'transparent', border: 'none', cursor: 'pointer', pointerEvents: 'auto' }} />
        <button id="nav-bonus" onClick={() => router.push('/bonus')}
          style={{ position: 'absolute', top: 1707, left: 167, width: 64, height: 59, background: 'transparent', border: 'none', cursor: 'pointer', pointerEvents: 'auto' }} />
        <button id="nav-affiliate" onClick={() => router.push('/affiliate')}
          style={{ position: 'absolute', top: 1707, left: 231, width: 64, height: 59, background: 'transparent', border: 'none', cursor: 'pointer', pointerEvents: 'auto' }} />
      </div>
        ...
        <div style={{
          ...
          <div style={{
            ...
            <form onSubmit={handleChangePassword}>
              ...
              {pwError && (
                <p style={{ fontFamily: 'Poppins, sans-serif', fontSize: '11px', color: '#ef4444', marginBottom: '10px' }}>⚠️ {pwError}</p>
              )}
