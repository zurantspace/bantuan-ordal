  ...
  return (
    <>
      ...
      >
        ...
        {/* Nav */}
        <button id="nav-home"      onClick={() => router.push('/home')}      style={{ position: 'absolute', top: 792, left: 39,  width: 64, height: 59, background: 'transparent', border: 'none', cursor: 'pointer', pointerEvents: 'auto' }} />
        <button id="nav-kelas"     onClick={() => router.push('/watch/1')}   style={{ position: 'absolute', top: 792, left: 103, width: 64, height: 59, background: 'transparent', border: 'none', cursor: 'pointer', pointerEvents: 'auto' }} />
        <button id="nav-affiliate" onClick={() => router.push('/affiliate')} style={{ position: 'absolute', top: 792, left: 167, width: 64, height: 59, background: 'transparent', border: 'none', cursor: 'pointer', pointerEvents: 'auto' }} />
        <button id="nav-profile"   onClick={() => router.push('/settings')}  style={{ position: 'absolute', top: 792, left: 231, width: 64, height: 59, background: 'transparent', border: 'none', cursor: 'pointer', pointerEvents: 'auto' }} />
      </ScaledIframeCanvas>
